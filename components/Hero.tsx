...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden font-mono" onMouseMove={handleMouseMove}>
      {/* SVG Wave Background */}
      ...
      <div className="relative z-40 flex flex-col items-center justify-center min-h-[80vh] px-6 md:px-8 text-center">
        <div className={`transition-all duration-1500 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="mb-6">
            <div className="inline-flex items-center space-x-2  bg-opacity-10 backdrop-blur-sm px-4 py-2 mb-8">
              <Star className="w-4 h-4 text-white" />
              <span className="text-white text-sm font-light tracking-wide">PREMIUM COLLECTION 2025</span>
            </div>
          </div>
        ...
        <div className={`flex flex-col md:flex-row gap-6 transition-all duration-1500 delay-1300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        {/* Brand Stats */}
        <div className={`flex flex-wrap justify-center gap-8 md:gap-12 mt-16 transition-all duration-1500 delay-1500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-black text-black md:text-white">500K+</div>
            <div className="text-sm tracking-wide text-black md:text-gray-400">HAPPY CUSTOMERS</div>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-black text-[#333333] ml-4">50+</div>
            <div className="text-sm  tracking-wide text-black ml-4">COUNTRIES</div>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-black text-black">15</div>
            <div className="text-sm text-black tracking-wide">YEARS EXPERIENCE</div>
          </div>
        </div>
      </div>

      {/* Scroll indicator */}
      <div className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-1500 delay-2000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        <div className="flex flex-col items-center space-y-2">
          <span className="text-white text-sm font-light tracking-widest">SCROLL</span>
